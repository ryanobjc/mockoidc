...
func (m *MockOIDC) Issuer() string {
	...
	if m.IssuerOverride != "" {
		return m.IssuerOverride + IssuerBase
	}
...
func (m *MockOIDC) DiscoveryEndpoint() string {
	...
	return m.Issuer() + DiscoveryEndpoint
}
...
func (m *MockOIDC) AuthorizationEndpoint() string {
	...
	return m.Issuer() + AuthorizationEndpoint
}
...
func (m *MockOIDC) UserinfoEndpoint() string {
	...
	return m.Issuer() + UserinfoEndpoint
}
